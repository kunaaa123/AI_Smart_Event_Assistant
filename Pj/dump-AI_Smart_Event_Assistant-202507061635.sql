...
CREATE TABLE `realms` (
  ...
  `only_owner` tinyint(1) DEFAULT '0',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_realms_owner` (`owner_id`),
  CONSTRAINT `fk_realms_owner` FOREIGN KEY (`owner_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
-- Dump completed on 2025-07-06 16:35:27
